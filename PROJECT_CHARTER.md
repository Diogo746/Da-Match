...
1. [Identificação Geral do Projeto](#1-identificação-geral-do-projeto)
2. [Matriz de Papéis & Equipe de Desenvolvimento](#2-matriz-de-papéis--equipe-de-desenvolvimento-scrum-roles)
3. [Visão do Produto & Problema a Resolver](#3-visão-do-produto--problema-a-resolver)
4. [Declaração do Escopo](#4-declaração-do-escopo-o-que-está-e-o-que-não-está-incluso)
5. [Mapeamento de Perfis de Acesso LLDAP (RBAC)](#5-mapeamento-de-perfis-de-acesso-lldap-rbac)
6. [Marcos de Entrega & Releases](#6-marcos-de-entrega--releases-milestones)
7. [Assinatura do Project Charter](#7-assinatura-do-project-charter)
...
| Campo                                   | Especificação                              |
| :--------------------------------------- | :------------------------------------------ |
| **Nome Oficial do Projeto**              | DaMatch                                     |
...
| **Repositório GitHub Oficial**           | `https://github.com/Diogo746/Da-Match`      |
...
O **DaMatch** será uma plataforma Web Full Stack responsiva para cadastrar e conectar startups ou projetos empreendedores a mentores e investidores interessados no ecossistema de inovação do Nordeste, ajudando-os a se encontrar de forma realmente compatível e reduzindo o tempo e o esforço necessários para descobrir e avaliar oportunidades de conexão.
...
Quando os dois lados demonstrarem interesse, a plataforma criará uma conexão e permitirá o registro de uma reunião. O DaMatch acompanhará o status dessa conexão, sem realizar investimentos, contratos ou movimentações financeiras dentro do sistema.
...
### 4.1 In-Scope — O que ESTÁ Incluso no Escopo do Semestre
...
### 4.2 Out-of-Scope — O que NÃO ESTÁ Incluso
